...
var IpWidget_StaticShareButton = function () {
    ...
    var openPopup = function () {
        ...
        $('#ipStaticSharePopup').remove(); //remove any existing popup. This could happen if other widget is in management state right now.

        //get popup HTML using AJAX. See AdminController.php widgetPopupHtml function
        var data = {
            aa: 'StaticShare.widgetPopupHtml',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var $popup = $('#ipStaticSharePopup .ipsModal');
                $popup.modal();
